...
}elseif(!in_array('corporate_trustees', $_SESSION['page_ids'])){
...
<head lang="en">
    ...
    <title>Corporate Trustees</title>
</head>
<body>
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <div class="row">
                <div class="col-md-6 add-btn-box"><a href="#" data-toggle="modal" data-target="#addCorporateTrusteeModal">
                        <button class="btn btn-primary btn-lg" value="">Add Trustee +</button>
                    </a></div>
                <form role="form" id="import-corporate-trustee-form" enctype="multipart/form-data">
            ...
            <form id="corporate-trustee-form" role="form" enctype="multipart/form-data" method="post">
    ...
    <div class="row">
        <?php include_once 'imports/add_corporate_trustee.php'; ?>
        <?php include_once 'imports/edit_corporate_trustee.php'; ?>
    </div>
</div>
</body>
</html>