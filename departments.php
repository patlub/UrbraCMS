...
<div class="container-fluid">
    ...
    <div class="col-md-12">
        <div class="success-alert row" align="center">Department has been added</div>
        <div id="deleted-alert" class=" row" align="center">Department have been deleted</div>
        <div class="error row" align="center">Network Error</div>
    </div>
    <div class="row">
        <div class="col-md-2 add-btn-box"><a href="#" data-toggle="modal" data-target="#addDepartmentModal">
