...
}elseif(!in_array('reports', $_SESSION['page_ids'])){
...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <div class="col-md-12">
                ...
                <div class="success-alert row" align="center">Report has been added</div>
                <div id="deleted-alert" class="error row" align="center">Report have been deleted</div>
                <div id="update-alert" class=" success-alert row" align="center">Report has been deleted</div>
            ...
            <div class="row">
                <div class="col-md-6 add-btn-box"><a href="#" data-toggle="modal" data-target="#addReportModal">
                        <button class="btn btn-primary btn-lg" value="">Add Report +</button>
                    </a></div>
            </div>
            <div class="row">
                <button id="publish" class="btn btn-default btn-lg pull-right" value="">PUBLISH</button>
            </div>
            <form id="reports-form" role="form" enctype="multipart/form-data">
    ...
    <div class="row">
        <?php include_once 'imports/add_report.php'; ?>
        <?php include_once 'imports/edit_report.php'; ?>
    </div>
</div>
</body>
</html>