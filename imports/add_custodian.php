<div class="modal fade" id="addCustodianModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" style="margin-top: 5%;">
                ...
                <div class="row">
                    <div class="col-md-7">
                        <form role="form">
                            ...
                            <div class="form-group">
                                <label for="link">Web Link</label><input type="text" id="link" name="link" class="form-control">
                            </div>
                            <div class="form-group">
