...
}elseif(!in_array('individual_trustees', $_SESSION['page_ids'])){
...
<head lang="en">
    ...
    <title>Individual Trustees</title>
</head>
<body>
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <div class="col-md-12">
                ...
                <div id="deleted-alert" class="error row" align="center">Trustee have been deleted</div>
                <div id="update-alert" class="success-alert row" align="center">Trustee has been deleted</div>
            ...
            <div class="row">
                <div class="col-md-6 add-btn-box"><a href="#" data-toggle="modal" data-target="#addIndividualTrusteeModal">
                        <button class="btn btn-primary btn-lg" value="">Add Trustee +</button>
                    </a></div>
                <form role="form" id="import-individual-trustee-form" enctype="multipart/form-data">
            ...
            <form id="individual-trustee-form" role="form" enctype="multipart/form-data" method="post">
    ...
    <div class="row">
        <?php include_once 'imports/add_individual_trustee.php'; ?>
        <?php include_once 'imports/edit_individual_trustee.php'; ?>
    </div>
</div>
</body>
</html>