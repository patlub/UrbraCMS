...
}elseif(!in_array('trustees', $_SESSION['page_ids'])){
...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <div class="row">
                <div class="col-md-6 add-btn-box"><a href="#" data-toggle="modal" data-target="#addTrusteeModal">
                        <button class="btn btn-primary btn-lg" value="">Add Trustee +</button>
                    </a></div>
                <form role="form" id="import-trustee-form" enctype="multipart/form-data">
            ...
            <form id="trustee-form" role="form" enctype="multipart/form-data" method="post">
    ...
    <div class="row">
        ...
        <?php include_once 'imports/edit_trustee.php'; ?>
    </div>
</div>
</body>
</html>