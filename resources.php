...
<div class="container-fluid">
    ...
    <div class="col-md-12">
        ...
        <div id="success-alert" class="success-alert row" align="center">Resource has been added</div>
        <div id="deleted-alert" class="error row" align="center">Resource have been deleted</div>
        <div id="update-alert" class="success-alert row" align="center">Resource has been updated</div>
    ...
    <div class="row">
        <?php include_once 'imports/add_resource.php'; ?>
        <?php include_once 'imports/edit_resource.php'; ?>
    </div>
</div>
</body>
</html>